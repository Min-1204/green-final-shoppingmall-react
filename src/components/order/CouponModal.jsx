        ...
        <div className="p-6 max-h-[450px] overflow-y-auto bg-[#f8fbff] space-y-3">
          {coupons.length === 0 ? (
            <div className="py-12 text-center">
              ...
              <h2 className="text-[#8ba4c7] font-medium">
                보유한 쿠폰이 없습니다.
              </h2>
            </div>
          ) : (
                ...
                >
                  ...
                  <div
                    className={`absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 rounded-r-full ${
                      isSelectable ? "bg-[#4a89d7]" : "bg-gray-300"
                    }`}
                  ></div>
                  ...
                  <div className="flex justify-between items-start mb-2">
                    <div
                      className={`font-bold text-[15px] ${
                        isSelectable ? "text-[#44526b]" : "text-gray-400"
                      }`}
                    >
                    ...
                    {isSelectable && (
                      <span
                        className="text-[10px] bg-[#eef6ff] text-[#4a89d7] px-2 py-0.5 rounded-full font-bold
                  ...
                  <div className="space-y-1">
                    ...
                    {coupon.coupon.discountType === "FIXED" ? (
                      <div
                        className={`text-[17px] font-black ${
                          isSelectable ? "text-[#4a89d7]" : "text-gray-400"
                        }`}
                      >
                      ...
                      <div
                        className={`text-[17px] font-black ${
                          isSelectable ? "text-[#4a89b7]" : "text-gray-400"
                        }`}
                      >
                    ...
                    <div
                      className={`text-[12px] ${
                        isSelectable ? "text-[#8ba4c7]" : "text-gray-400"
                      }`}
                    >
                      {isLimit ? (
                        <span>

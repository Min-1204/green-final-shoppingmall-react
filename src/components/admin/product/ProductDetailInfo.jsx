...
export default function ProductDetailInfo({ onChangeForm }) {
  ...
  useEffect(() => {
    onChangeForm({ ...productDetailInfo });
  }, [productDetailInfo]);

  const onChangeHandler = (e) => {
    const { name, value } = e.target;

    setProductDetailInfo((prev) => {
      const detailInfo = { ...prev, [name]: value };
      return detailInfo;
    });
  };
          ...
          <div className="border border-gray-300 mb-6 rounded-lg overflow-hidden shadow-lg">
            ...
            <div className="flex border-b border-gray-300 items-stretch">
              ...
              <div className="flex items-center flex-grow p-2 gap-2">
                ...
                />
                <span className="text-xs text-gray-500 whitespace-nowrap">
                  {productDetailInfo.functionalCertification.length} / 255
                </span>
              </div>
            </div>

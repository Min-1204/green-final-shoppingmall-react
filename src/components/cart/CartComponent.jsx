...
import { ShoppingCart, Trash2, Plus, Minus, Sparkles, Moon } from "lucide-react";
...
const CartComponent = () => {
  ...
  const shipping =
    (totalPrice >= selectedCartItems[0]?.deliveryPolicy?.freeConditionAmount
      ? 0
      : selectedCartItems[0]?.deliveryPolicy?.basicDeliveryFee) || 3000;
    ...
    return (
      <div className="max-w-5xl mx-auto mt-20 px-4">
        <div className="bg-white/80 backdrop-blur-sm rounded-[30px] shadow-sm border border-blue-100 p-20 text-center">
          ...
          <button onClick={()=>navigate("/")} className="px-8 py-3 bg-blue-400 text-white rounded-full hover:bg-blue-500 transition-all shadow-md shadow-blue-100">
            쇼핑하러 가기
          </button>
        </div>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="bg-blue-50/30 border-b border-blue-50">
              <tr>
                <th className="w-16 p-5 text-center text-xs font-bold text-blue-400 uppercase tracking-wider whitespace-nowrap">선택</th>
      ...
      <div className="bg-gradient-to-br from-white to-blue-50/30 border border-blue-100 rounded-[30px] shadow-sm p-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="text-center md:border-r border-blue-100">
            ...
            <p className="text-xl font-bold text-slate-700">{totalPrice.toLocaleString()}원</p>
          </div>
        <div className="text-center md:border-r border-blue-100">
        ...
        <div className="text-center">
          <p className="text-xs font-bold text-blue-400 mb-2">총 결제 예상 금액</p>
